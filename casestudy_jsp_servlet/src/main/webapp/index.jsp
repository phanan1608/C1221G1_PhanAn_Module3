...
<head>
    ...
    <link rel="shortcut icon" href="https://furamavietnam.com/wp-content/uploads/2018/07/favicon.png" type="image/x-icon">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#" style="color: #EAEF57;"> Home<span class="sr-only">(current)</span></a>
                </li>
...
<div>
    <img src="https://images.vietnamtourism.gov.vn/vn/images/2021/resort_phu_quoc_1.jpg"
         style="width: 100%"
         alt="">
</div>
