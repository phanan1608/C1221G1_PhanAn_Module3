        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <c:forEach var="employee" items="${employee}">
                <tr>
                    ...
                    <td>
                        <c:forEach var="position" items="${position}">
                            <c:if test="${position.positionId eq employee.positionId}">
                    ...
                    <td>
                        <c:forEach var="education_degree" items="${education_degree}">
                            <c:if test="${education_degree.educationDegreeId eq employee.educationDegreeId}">
                                ${education_degree.educationDegreeName}
                                <%--                        <c:out value="${type.customerTypeName}"></c:out>--%>
                            </c:if>
                        </c:forEach>
                    </td>
                    <td>
                        <c:forEach var="division" items="${division}">
                            <c:if test="${division.divisionId eq employee.divisionId}">
